<%@ Page Title="" Language="C#" MasterPageFile="~/Back.Master" AutoEventWireup="true" CodeBehind="YachtDimension.aspx.cs" Inherits="Yacht0402.BackPage.YachtDimension" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    ...
    <div class="d-flex">
        <div>
            <div class="mt-2">
                <asp:Button ID="Button1" runat="server" Text="新增Dimension" CssClass="btn btn-secondary mb-3 ml-3" OnClick="Button1_Click" />
                <asp:Panel ID="Panel1" runat="server" Visible="false">
                    ...
                    <div class="d-flex ml-3 mt-2">
                        <asp:Button ID="Button2" runat="server" Text="取消新增" CssClass="btn btn-secondary" OnClick="Button2_Click" />
                        <asp:Button ID="Button3" runat="server" Text="送出新增" CssClass="ml-2 btn btn-secondary" OnClick="Button3_Click" />
                    </div>
                </asp:Panel>
            </div>

            <asp:GridView ID="gridview1" runat="server" AutoGenerateColumns="False" OnRowCancelingEdit="gridview1_RowCancelingEdit" OnRowEditing="gridview1_RowEditing" OnRowDeleting="gridview1_RowDeleting" DataKeyNames="Id" CssClass="ml-4 mt-3 table table-bordered table-hover" OnRowUpdating="gridview1_RowUpdating" Height="153px" Width="413px">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Name">
                        <ItemTemplate>
                            ...
                            <asp:Label ID="Label" runat="server" Text='<%# Bind("Name") %>'></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="Label3" runat="server" Text='<%# Bind("Name") %>' TextMode="MultiLine"></asp:TextBox>
                        </EditItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Value">
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="Labe15" runat="server" Text='<%# Bind("Value") %>' TextMode="MultiLine"></asp:TextBox>
                        </EditItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
        ...
        <div class="mt-3 ml-3">
            <asp:Label ID="Label5" runat="server" Text="圖片只能上傳一張"></asp:Label>
            <asp:Panel ID="Panel2" runat="server" CssClass="mt-3">
                <div>
                    <asp:FileUpload ID="FileUpload1" runat="server" />
                    <asp:Button ID="Button4" runat="server" Text="上傳" OnClick="Button4_Click" CssClass="btn btn-secondary" />
                </div>
                <div class="mt-3">
                    <asp:Label Text="目前上傳照片: " runat="server" />
                    <asp:Image ID="Image1" runat="server" Width="200px" Height="230px" CssClass="ml-3"/>
                </div>
            </asp:Panel>
        </div>
    </div>
