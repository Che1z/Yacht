<%@ Page Title="" Language="C#" MasterPageFile="~/Back.Master" AutoEventWireup="true" CodeBehind="DealerArea.aspx.cs" Inherits="Yacht0402.BackPage.Dealer" %>
...
<%--                            <span class="px-1 mr-lg-2 ml-2 ml-lg-0">Jeremy Hung</span>--%>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    <div class="ml-3">
        <asp:GridView ID="gridview1" runat="server" DataKeyNames="Id" Height="180px" Width="300px" OnRowCancelingEdit="gridview1_RowCancelingEdit" OnRowDeleting="gridview1_RowDeleting" OnRowEditing="gridview1_RowEditing" OnDataBound="gridview1_DataBound" OnRowDataBound="gridview1_RowDataBound" CssClass="table-striped table table-hover mt-4 center-text " OnRowUpdating="gridview1_RowUpdating">
            <Columns>
        ...
        <asp:Button ID="Button1" runat="server" Text="新增Area" CssClass="mt-4 mb-4 btn btn-secondary" OnClick="Button1_Click" />
        <asp:Panel ID="Panel1" runat="server" Visible="false">
            <div cssclass="d-flex">

                <asp:Label ID="Label1" runat="server" Text="區域名稱: "></asp:Label>
                <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                <asp:Button ID="Button2" runat="server" Text="送出" OnClick="Button2_Click" CssClass="mb-2 btn btn-secondary" />
