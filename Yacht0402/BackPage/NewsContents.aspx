<%@ Page Title="" Language="C#" MasterPageFile="~/Back.Master" AutoEventWireup="true" CodeBehind="NewsContents.aspx.cs" Inherits="Yacht0402.BackPage.NewsContents" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <link href="../CSS/backshreerang.css?v=1" rel="stylesheet" />
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    <asp:GridView ID="gridview1" runat="server" OnRowUpdating="gridview1_RowUpdating" OnRowDataBound="gridview1_RowDataBound" CssClass="ml-2 mt-2 mr-3 table-striped table table-hover" OnRowEditing="gridview1_RowEditing" OnDataBound="gridview1_DataBound" OnRowCancelingEdit="gridview1_RowCancelingEdit" Width="1574px" AutoGenerateColumns="False">
        <Columns>
            <asp:CommandField ShowEditButton="True" />
            <asp:TemplateField HeaderText="編輯相簿">
                <ItemTemplate>
                    <asp:Label ID="Label1" runat="server" Text='<%# Bind("Id") %>' Visible="false"></asp:Label>
                    <asp:Button CssClass="btn btn-primary ml-2 " ID="Button2" runat="server" Text="編輯相簿" />
                </ItemTemplate>
                <EditItemTemplate>
                    <asp:Label ID="Label1" runat="server" Text='<%# Bind("Id") %>' Visible="false"></asp:Label>
                    <asp:Button ID="Button2" runat="server" Text="編輯相簿" />
                </EditItemTemplate>
            </asp:TemplateField>

            <asp:TemplateField HeaderText="Title">
                <ItemTemplate>
                    <asp:Label ID="TextBox2" runat="server" Text='<%# Bind("Title") %>'></asp:Label>
                </ItemTemplate>
                <EditItemTemplate>
            ...
            <asp:TemplateField HeaderText="Contents">
                <ItemTemplate>
                    <asp:Label ID="TextBox3" runat="server" Text='<%# Bind("Contents") %>'></asp:Label>
                </ItemTemplate>
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox3" runat="server" Text='<%# Bind("Contents") %>' Width="500px" Height="100px" TextMode="MultiLine"></asp:TextBox>
                </EditItemTemplate>
            </asp:TemplateField>
        </Columns>
    </asp:GridView>
