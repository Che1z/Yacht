<%@ Page Title="" Language="C#" MasterPageFile="~/Back.Master" AutoEventWireup="true" CodeBehind="DealerNumber.aspx.cs" Inherits="Yacht0402.BackPage.DealerNumber" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    <div cssclass="d-flex mt-2">
        ...
        <asp:GridView ID="gridview1" runat="server" CssClass="table-striped table table-hover mt-4 center-text ml-2 mr-2" Width="500px" DataKeyNames="Id" OnRowCancelingEdit="gridview1_RowCancelingEdit" OnRowDataBound="gridview1_RowDataBound" OnRowDeleting="gridview1_RowDeleting" OnRowEditing="gridview1_RowEditing" OnRowUpdating="gridview1_RowUpdating">
            <Columns>
        ...
        <asp:Panel ID="Panel1" runat="server" Visible=" false" CssClass="mt-3">
            <div cssclass="d-flex ">
                <table class=" table-active  table-bordered ml-2 ">
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label4" runat="server" Text="cellNumber: "></asp:Label></td>
                        <td>
                            <asp:TextBox ID="TextBox3" runat="server"></asp:TextBox></td>
                        <td>
                            <asp:Label ID="Label5" runat="server" Text="faxNumber: "></asp:Label></td>
                        <td>
                            <asp:TextBox ID="TextBox4" runat="server"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="Label6" runat="server" Text="telNumber: "></asp:Label></td>
                        <td>
