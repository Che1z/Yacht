<%@ Page Title="" Language="C#" MasterPageFile="~/Back.Master" AutoEventWireup="true" CodeBehind="DealerPhoto.aspx.cs" Inherits="Yacht0402.BackPage.DealerPhoto" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    <div cssclass="d-flex ">
        ...
        <asp:DropDownList ID="DropDownList1" runat="server"  Width="220px" AutoPostBack="True" CssClass="btn btn-default dropdown-toggle waves-effect"  OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged"></asp:DropDownList>
        <asp:GridView ID="gridview1" Width="500px" runat="server" DataKeyNames="Id" OnRowCancelingEdit="gridview1_RowCancelingEdit" OnRowDataBound="gridview1_RowDataBound" OnRowDeleting="gridview1_RowDeleting" OnRowEditing="gridview1_RowEditing" OnRowUpdating="gridview1_RowUpdating" CssClass="ml-2 mt-2 table-striped table table-hover ">
            <Columns>
                <asp:CommandField ShowEditButton="True" />
                <asp:CommandField ShowDeleteButton="True" />
                <asp:TemplateField HeaderText="聯絡人圖片預覽">
                    <EditItemTemplate>
                        <asp:Label ID="Label2" runat="server" Text="選擇封面圖:"></asp:Label>
                        <asp:DropDownList ID="DropDownList2" runat="server" CssClass="btn btn-default dropdown-toggle waves-effect"></asp:DropDownList>
                        <br />
                        <br />
                ...
                <asp:TemplateField HeaderText="上傳圖片">
                    <EditItemTemplate>
                        ...
                        <br />
                        <br />
                        <asp:Button ID="Button1" runat="server" Text="上傳圖片" OnClick="Button1_Click" CssClass="btn btn-secondary ml-2" />
                    </EditItemTemplate>
                    <ItemTemplate>
                    </ItemTemplate>
                </asp:TemplateField>
