...
namespace Yacht0402.BackPage
{
    public partial class YachtLayout : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            ///
            string ServerFolderPath = Server.MapPath("~/BackPage/YachtLayoutPhoto/");
            ...
            if (FileUpload1.HasFiles)
            {
                ...
                foreach (var postfile in FileUpload1.PostedFiles)
                {
                    ...
                    string pathStore = "/BackPage/YachtLayoutPhoto/" + fileName;
                    string sql = $"INSERT INTO YachtLayoutPhoto(fileName, imgPath, ListId) VALUES(@fileName, @filePath, @ListId)";
        ...
        public void showRP1()
        {
            ...
            sql = "SELECT  * FROM YachtLayoutPhoto yp " +
                "Where yp.ListId = @Id";
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            foreach (RepeaterItem item in Repeater1.Items)
            {
                ...
                if (cb.Checked)
                {
                    ...
                    SqlCommand sqlcommand = new SqlCommand();
                    sqlcommand.Connection = connection;
                    string sqlCommand = $"DELETE FROM yachtLayoutPhoto Where Id = @Id";
