<%@ Page Title="" Language="C#" MasterPageFile="~/Back.Master" AutoEventWireup="true" CodeBehind="YachtModel.aspx.cs" Inherits="Yacht0402.BackPage.yachtModel" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    <asp:Panel ID="Panel1" runat="server" CssClass=" ml-3 mt-3 d-flex ">
        <div>
            <asp:Button ID="Button1" runat="server" Text="新增Model" CssClass="ml-3 btn btn-secondary" OnClick="Button1_Click" />
            <asp:Panel ID="Panel2" runat="server" CssClass="ml-3" Visible="false">
                <div>
                    <table class="border table">
                        ...
                        <tr>
                            <td>
                                <asp:Button ID="Button3" runat="server" Text="取消送出" CssClass="mt-2 btn btn-round btn-outline-default" OnClick="Button3_Click" />

                                <asp:Button ID="Button2" runat="server" Text="送出" CssClass="mt-2 ml-2 btn btn-round btn-outline-default" OnClick="Button2_Click" />
                            </td>
                        </tr>
                    </table>
                </div>
    ...
    <asp:GridView ID="gridview1" runat="server" CssClass="ml-3 mt-4 table table-bordered table-hover" OnRowEditing="gridview1_RowEditing" OnRowCancelingEdit="gridview1_RowCancelingEdit" OnRowDataBound="gridview1_RowDataBound" OnRowDeleting="gridview1_RowDeleting" DataKeyNames="Id" Height="182px" OnRowUpdating="gridview1_RowUpdating" Width="479px">
        <Columns>
