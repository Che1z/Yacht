<%@ Page Title="" Language="C#" MasterPageFile="~/Back.Master" AutoEventWireup="true" CodeBehind="YachtLayout.aspx.cs" Inherits="Yacht0402.BackPage.YachtLayout" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    ...
    <asp:Panel ID="panel1" runat="server" CssClass="ml-3 mt-2 border-primary">
        <div class="custom-file mb-3" style="max-width: 500px;">
            <asp:FileUpload runat="server" CssClass="" ID="FileUpload1" AllowMultiple="True" />
            <asp:Button ID="Button1" runat="server" Text="上傳檔案" CssClass="btn btn-outline-secondary" OnClick="Button1_Click" />
        </div>
    </asp:Panel>
    <%--    Repeater--%>
    <asp:Repeater ID="Repeater1" runat="server">
        <HeaderTemplate>
            <div class=" ">
                <table class="  table-bordered  table-hover w-90 ml-3">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td>
                    <asp:Label ID="Label3" runat="server" Text='<%#Eval("createAt") %>'></asp:Label>
                </td>
            </tr>
        </ItemTemplate>
        <FooterTemplate>
            ...
            <asp:Button ID="Button2" runat="server" Text="刪除圖片" CssClass="btn btn-outline-secondary ml-3 mt-3" OnClick="Button2_Click" Width="300px" />
        </FooterTemplate>
    </asp:Repeater>
